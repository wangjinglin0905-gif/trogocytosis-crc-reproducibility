...
Release `v1.1.0` adds approved submission-display figures and portable plotting sources accompanying manuscript V8.6; the numerical basis remains V8.1. Its exact GitHub snapshot is identified by tag `v1.1.0`, and its matching Zenodo archive is [10.5281/zenodo.22669531](https://doi.org/10.5281/zenodo.22669531). No manuscript text or private screening report is included. The archive was built before DOI assignment; embedded pending-status citation text is a preserved historical snapshot, superseded by this metadata-only repository update and the release note. Archive bytes, source tags and frozen numerical results are unchanged.
